...
$(document).ready(function(){
	...
	$('#agregar').click(function(){
		...
		var municipio2= parseInt(municipio);
		...
		if(municipio_text!="" && lugar_destino!="" && mision_encomendada!="" && municipio2>=0) {
	...
	{
		var tabla_destinos = document.getElementsByName('values[]').length;
		
		if(tabla_destinos==0)
		{
			band=false;
			alertify.alert('Error, no ha seleccionado ningún destino');
		}
		else if(band==false)
		{
			band=true;
