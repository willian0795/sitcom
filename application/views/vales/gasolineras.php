...
?>
  <tr>
    ...
    <td>
    	<a class="modificar" title="Modificar <?php echo $titulo?>" rel="leanModal" href="#ventana" data-id_gasolinera="<?php echo $val['id_gasolinera']?>" data-nombre="<?php echo ucwords($val['nombre'])?>"><img src="<?php echo base_url()?>img/editar.png"/></a>
