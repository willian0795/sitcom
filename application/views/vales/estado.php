        ...
        function tabla1(data, div, id) {
            ...
            var html='<table cellspacing="0" align="right" class="table_design" id="reportv'+id+'">'+
                 ...
                 for (var i = 0; i < data.length; i++) {
                    ...
                    '        <td><a title="Imprimir"  onclick="reporte('+data[i].id_requisicion_vale+',1)"><img  src="'+base_url()+'img/lupa.gif"/></a></td>'+
                    '    </tr>'+
                    '    <tr>'+
                 ...
                 <?php
                    ...
                    foreach($ne as $val) { ?>
                        <tr onClick="detalles(<?php echo $val['id_vale'] ?>)"> 
                            ...
                            <td><a title="Imprimir"  onclick="reporte(<?php echo $fila['id_vale']?>,0)"><img  src="<?php echo base_url()?>img/lupa.gif"/></a></td>
                        </tr>
                        <tr>
