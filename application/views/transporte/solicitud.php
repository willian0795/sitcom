<script>
	...
	estado_incorrecto='Error al intentar guardar la solicitud: No se pudo conectar al servidor. Por favor vuelva a intentarlo.';
...
<form name="form_mision" method="post" action="<?php echo base_url()?>index.php/transporte/guardar_solicitud">
	...
	<div id="wizard" class="swMain">
        <ul>
            <li>
                <a href="#step-1">
                    <span class="stepNumber">1<small>Solicitante</small></span>
                    <span class="stepDesc">
                        <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paso--><br/>
            ...
            <li>
                <a href="#step-2">
                    <span class="stepNumber">2<small>Misi&oacute;n</small></span>
                    <span class="stepDesc">
                        <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paso--><br/>
            ...
            <li>
                <a href="#step-3">
                    <span class="stepNumber">3<small>Destino</small></span>
                    <span class="stepDesc">
                        <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paso--><br/>
            ...
            <li>
                <a href="#step-4">
                    <span class="stepNumber">4<small>Acompa&ntilde;antes</small></span>
                    <span class="stepDesc">
                        <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paso--><br/>
        ...
        <div id="step-2">	
            ...
            <p>
				...
				<label for="correo_cc" id="lcorreo_cc">Correo CC: </label>
                <input type="text" tabindex="4" id="correo_cc" name="correo_cc" value="<?php echo $solicitud['correo_cc']; ?>"/>
            </p>
            <p>
                <label for="hora_salida" id="lhora_salida">Hora de salida </label>
                <input type="text" tabindex="5" class="inicio" id="hora_salida" name="hora_salida" value="<?php echo $solicitud['hora_salida']; ?>"/>

                <label for="hora_regreso" id="lhora_regreso">Hora de regreso </label>
                <input type="text" tabindex="6" class="fin" id="hora_regreso" name="hora_regreso" value="<?php echo $solicitud['hora_entrada']; ?>"/>
            </p>
