              	...
              	<?php
						for($x=0;$x<count($modulo);$x++) {
							if($url[$x]=="NULL")
								...
								$tipo='href="'.base_url().'index.php/'.$url[$x].'" id="verMenu'.$id[$x].'"';
...
<div id="ventana2" style="height:600px">
    <div id='signup-header'>
        <h2>Combustible para vehiculos en taller</h2>
        <a class="modal_close"></a>
    </div>
    <div id='contenido-ventana2'>
    </div>
</div>